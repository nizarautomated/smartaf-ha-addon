...
def execute_command(command: str, target: str | None) -> dict[str, Any]:
    ...
    if command in MUTATING_ADDON_COMMANDS and target == self_addon_slug():
        raise ValueError("the command runner cannot mutate its own add-on")
